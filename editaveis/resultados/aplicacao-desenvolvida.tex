...
Todo o código de testes pode ser encontrado no repositório da aplicação (https://github.com/Guimifiu/guimifiu-app), um exemplo de teste unitário e um de teste de integração está disponível no Anexo \ref{chap:testes}.
