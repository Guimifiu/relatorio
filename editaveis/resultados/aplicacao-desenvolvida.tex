...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_1.jpg}
        \caption[Tela de autenticação do aplicativo.]{Tela de autenticação do aplicativo. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_4.jpg}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_10.jpg}
        \caption[Tela de preenchimento de dados do abastecimento feito.]{Tela de preenchimento de dados do abastecimento feito. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_5.jpg}
        \caption[Tela de detalhes do posto onde o usuário se encontra.]{Tela de detalhes do posto onde o usuário se encontra. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
    \item Eu, como motorista, gostaria de editar o meu cadastro para manter minhas informações atualizadas;
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_3.jpg}
        \caption[Tela de edição de dados do usuário.]{Tela de edição de dados do usuário. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/admin_screenshot_1.png}
        \caption[Tela inicial do sistema administrador.]{Tela inicial do sistema administrador. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/admin_screenshot_2.png}
        \caption[Tela de criação de boicotes por bandeira no sistema administrador.]{Tela de criação de boicotes por bandeira no sistema administrador. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_8.jpg}
        \caption[Tela com o gráfico dos gastos mensais para os diferentes tipos de combustíveis.]{Tela com o gráfico dos gastos mensais para os diferentes tipos de combustíveis. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
    \item Eu, como motorista, gostaria de visualizar um histórico de postos onde passei para controlar melhor os meus gastos;
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_6.jpg}
        \caption[Tela com o histórico de abastecimentos do usuário.]{Tela com o histórico de abastecimentos do usuário. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{figuras/app_final_7.jpg}
        \caption[Tela com o histórico de abastecimentos do usuário em postos com bandeiras definidas.]{Tela com o histórico de abastecimentos do usuário em postos com bandeiras definidas. Fonte: autores}
        \label{img:telaautenticacao}
    \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{figuras/historico-app.jpg}
    \caption[Página inicial do módulo de administração]{Página inicial do módulo de administração. Fonte: autores}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{figuras/grafico-app.jpg}
    \caption[Página inicial do módulo de administração]{Página inicial do módulo de administração. Fonte: autores}
