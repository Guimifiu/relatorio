...
O \textit{Crazy Eights} é uma técnica onde os participantes possuem 5 miutos para desenhar as 8 telas principais do aplicativo, sendo assim 40 sengundos para cada uma. O objetivo principal é ser bem direto e como o tempo é curto, apenas os pontos cruciais para o aplicativo serão desenhados.(https://library.gv.com/the-product-design-sprint-diverge-day-2-c7a5df8e7cd0)
...
Com os requisitos valdiados, foram desenhados protótipos de baixa fidelidade para a histórias de usuários que seriam desenvolvidas.
