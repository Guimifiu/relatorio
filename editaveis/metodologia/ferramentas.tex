...
Os requisitos estão sendo mantidos no GitHub como \textit{issues} para controlar o \textit{status} no \textit{kanban} do \citeonline{waffle} na ferramenta Waffle.io. O Waffle é uma ferramenta de gerência de projetos que utiliza as \textit{issues} do GitHub para manter os requisitos de um projeto em um \textit{kanban} online automaticamente. Além disso, o Waffle também gera gráficos para monitorar o projeto \cite{waffle-ca}
